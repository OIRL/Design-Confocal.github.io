...
## Zemax files
Download the different files for the ZEMAX confocal microscope
<br>
[file.ZDA](ZEMAX files/Confocal_Microscope_Final.ZDA)
<br>
[file.ZMX](ZEMAX files/Confocal_Microscope_Final.zmx)
